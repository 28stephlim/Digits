...
class DetailViewController: UIViewController {
    ...
    // TEST BUTON HERE DELETE THIS AND BUTTON LATEER
    /////////////////////////////////////////////////
    /////////////////////////////////////////////////
    /////////////////////////////////////////////////
    /////////////////////////////////////////////////
    ...
    @IBAction func testButton(sender: UIButton) {
       ...
       print("Comparing normal vs innocent signal")
        
        let path1 = NSBundle.mainBundle().pathForResource("normal", ofType: "mp3")
        let firstURL = NSURL.fileURLWithPath(path1!)
        
        let path2 = NSBundle.mainBundle().pathForResource("innocent", ofType: "mp3")
        let secondURL = NSURL.fileURLWithPath(path2!)
